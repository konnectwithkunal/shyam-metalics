...
export default function Testimonials() {
  ...
  return (
    <section className="py-12 md:py-16 px-4 lg:px-16 relative">
  {/* Background Image */}
  <div
  ...
  <div className="max-w-7xl mx-auto relative z-10">
    ...
    <div ref={headerRef} className="text-center mb-8 md:mb-12">
      <h2
        className={`text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-3 md:mb-4 transition-all duration-1000 ${
      ...
      {testimonials.map((testimonial, index) => (
        ...
        >
          ...
          <div className="bg-white rounded-2xl md:rounded-[30px] shadow-[0_8px_30px_rgba(0,0,0,0.08)] relative flex flex-col cursor-pointer border border-gray-100 overflow-hidden group transition-all duration-150 hover:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_8px_10px_-6px_rgba(0,0,0,0.1)] hover:-translate-y-2 hover:scale-[1.03]">
            ...
            >
              <div className="w-0 h-0 border-t-[40px] md:border-t-[60px] border-t-[#f97316] border-l-[40px] md:border-l-[60px] border-l-transparent" />
            </div>
            ...
            <div className="p-4 md:p-6 pb-3 md:pb-4 flex-1">
              ...
              <button
                ...
                className="text-[#F25822] font-semibold text-xs md:text-sm hover:opacity-80 flex items-center gap-1"
                style={{
                  opacity: cardsInView ? 1 : 0,
                  transform: cardsInView ? 'translateX(0)' : 'translateX(-20px)',
            ...
            <div
              className="h-[2px] md:h-[3px] bg-[#F25822] w-full"
              style={{
                opacity: cardsInView ? 1 : 0,
